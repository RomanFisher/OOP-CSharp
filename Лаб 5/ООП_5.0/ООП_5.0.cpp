// ООП_5.0.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
public:
    void showTovar() override
    {
        ...
        cout << "Вікові обмеження : +" << yearInChildren << "\n";
        cout << "Кількість сторінок : " << st.number << "\n";
        cout << "\n_________________________\n";
